...
exports.default = async function (context) {
  ...
  if (platform === 'mac') {
    // macOS 的语言文件位置
    resourceDirs = [
      path.join(context.appOutDir, 'CaKa AI.app', 'Contents', 'Resources'),
      path.join(context.appOutDir, 'CaKa AI.app', 'Contents', 'Frameworks', 'Electron Framework.framework', 'Resources')
    ]
  } else {
