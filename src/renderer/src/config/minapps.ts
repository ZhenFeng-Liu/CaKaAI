...
import LeonardoLogo from '@renderer/assets/images/apps/Leonardo.ai.png?url'
...
import JimengLogo from '@renderer/assets/images/apps/即梦AI.png?url'
import TongyiWanxiangLogo from '@renderer/assets/images/apps/通义万相.png?url'
