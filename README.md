...
CaKa AI is a desktop client that supports for multiple LLM providers, available on Windows, Mac and Linux.
...
❤️ Like CaKa AI? Give it a star 🌟 or [Sponsor](docs/sponsor.md) to support the development!
...
We welcome contributions to CaKa AI! Here are some ways you can contribute:
...
7. **Promote Usage**: Spread the word about CaKa AI.
